...
if __name__ == '__main__':
    ...
    # parser.add_argument('--threshold', nargs='+', type=int, default = 150, help='List of thresholds')
    # parser.add_argument('--neighbors', nargs='+', type=float, default = 4, help='List of neighbors values')
